...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  header("Location: edit_owner_profile.php");
  exit;
}
  ...
  <div class="container">
    <div class="card">
      <div class="card-body">
        ...
        <?php endif; ?>
        <h3 class="text-center"> Owner's Profile Information</h3>

        <form action="edit_owner_profile.php" method="post" enctype="multipart/form-data" class="mt-4">
