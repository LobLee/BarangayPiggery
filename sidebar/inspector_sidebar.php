...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="inspector_dashboard.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="inspect_piggery.php">
                    <i class="fas fa-fw fa-piggy-bank"></i> <!-- Changed to piggy bank icon for inspecting piggery -->
                    <span>Piggeries</span></a>
            </li>


            <li class="nav-item">
                <a class="nav-link" href="results.php">
                    <i class="fas fa-fw fa-clipboard-check"></i> <!-- Changed to clipboard check for inspection results -->
                    <span>Inspect Piggery</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="incident_actions.php">
                    <i class="fas fa-fw fa-exclamation-triangle"></i> <!-- Changed to clipboard check for inspection results -->
                    <span>Incident Actions</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="inspector_profile.php">
